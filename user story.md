# As a user, I want to set up 3 images in html with id's and source attributes set to an empty string. get elements by id for all 3 images. add event listeners to those images
